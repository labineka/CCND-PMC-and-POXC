...
meta = read.csv("CCND25_run1.csv", header=TRUE)
...
write.csv(meta, "CCND PMC 2025 rd1 calcs full.csv",
          row.names = FALSE)
...
meta = read.csv("CCND25_run2.csv", header=TRUE)
#sample data and approx times, sep="," for csv

str(meta)

licor = read.table("Run 2.txt", header = TRUE,
                   sep="\t", #tab-delim
                   skip = 1, #skip the first two lines
                   col.names = c("date", "time", "ppm", "temp","press",
                                 "abs", "voltage", "flow", "junk"))
...
write.csv(meta, "CCND PMC 2025 rd2 calcs full.csv",
          row.names = FALSE)
...
meta = read.csv("CCND25_run3.csv", header=TRUE)
#sample data and approx times, sep="," for csv

str(meta)

licor = read.table("Run 3.txt", header = TRUE,
                   sep="\t", #tab-delim
                   skip = 1, #skip the first two lines
                   col.names = c("date", "time", "ppm", "temp","press",
                                 "abs", "voltage", "flow", "junk"))
...
write.csv(meta, "CCND PMC 2025 rd3 calcs full.csv",
          row.names = FALSE)
...
meta = read.csv("CCND25_run4.csv", header=TRUE)
#sample data and approx times, sep="," for csv

str(meta)

licor = read.table("Run 4.txt", header = TRUE,
                   sep="\t", #tab-delim
                   skip = 1, #skip the first two lines
                   col.names = c("date", "time", "ppm", "temp","press",
                                 "abs", "voltage", "flow", "junk"))
...
write.csv(meta, "CCND PMC 2025 rd4 calcs full.csv",
          row.names = FALSE)
...
meta = read.csv("CCND25_run5.csv", header=TRUE)
#sample data and approx times, sep="," for csv

str(meta)

licor = read.table("Run 5.txt", header = TRUE,
                   sep="\t", #tab-delim
                   skip = 1, #skip the first two lines
                   col.names = c("date", "time", "ppm", "temp","press",
                                 "abs", "voltage", "flow", "junk"))
...
write.csv(meta, "CCND PMC 2025 rd5 calcs full.csv",
          row.names = FALSE)
...
meta = read.csv("CCND25_run6.csv", header=TRUE)
#sample data and approx times, sep="," for csv

str(meta)

licor = read.table("Run 6.txt", header = TRUE,
                   sep="\t", #tab-delim
                   skip = 1, #skip the first two lines
                   col.names = c("date", "time", "ppm", "temp","press",
                                 "abs", "voltage", "flow", "junk"))
...
write.csv(meta, "CCND PMC 2025 rd6 calcs full.csv",
          row.names = FALSE)
...
meta = read.csv("CCND25_run7.csv", header=TRUE)
#sample data and approx times, sep="," for csv

str(meta)

licor = read.table("Run 7.txt", header = TRUE,
                   sep="\t", #tab-delim
                   skip = 1, #skip the first two lines
                   col.names = c("date", "time", "ppm", "temp","press",
                                 "abs", "voltage", "flow", "junk"))
...
write.csv(meta, "CCND PMC 2025 rd7 calcs full.csv",
          row.names = FALSE)

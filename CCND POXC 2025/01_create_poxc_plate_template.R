...
#This is easily avoided by renaming the templates folder after you've run the script successfully the first time, 
#or supplying a different dir name in the "make dir if needed" section if you plan to run the script multiple times.
...
#I did it this way because it's pretty common for me to process multiple plates worth of data at the same time, 
#and wrapping this code in function(s) is a way to avoid repeating the lines over and over for each plate.
...
make_poxc_plater_temp <- function(target_path) {
  ...
  maps <-
    readr::read_csv("raw_data/plate.maps.csv", col_types = "cccccccccccccc")
